...
//int main()
//{
//	int dists[NUM_OF_NODE][NUM_OF_NODE]
//	{
//		{0, 2, 5, 1, INF, INF},
//		{2, 0, 3, 2, INF, INF},
//		{5, 3, 0, 3, 1, 5},
...
//	q.push(startNode);
//	
//	bool isVisited[NUM_OF_NODE];
//	int minDists[NUM_OF_NODE];
//	for (int i = 0; i < NUM_OF_NODE; i++)
//	{
//		isVisited[i] = false;
//		minDists[i] = dists[startNode][i];
//	}
//
//	int curNode;
//	while (true)
...
//				continue;
//
//			if (minDists[curNode] + dists[curNode][i] >= minDists[i])
//				continue;
//
//			minDists[i] = minDists[curNode] + dists[curNode][i];
//		}
//
//		int minDist = INF;
//		int minDistNode;
